% UL
[LS2_sweep, fs2] = audioread("sounds/UL_GDP/RIR_UL_Unity_bf.wav");
[sweep, fsst] = audioread("sounds/UL_GDP/sine_sweep_16bit.wav");
[RT60, DRR, C50, Cfs, EDT] = ...
iosr.acoustics.irStats("sounds/UL_GDP/RIR_UL_Unity_bf.wav",'graph', true, 'spec', 'full', 'y_fit', [-5 -46]);
