...
%..........................................................................    
    ...
    %cfs = cfs(:);
% 
     % Modified by Atiyeh 07/02/2023 03:33 pm. following the RSAO cfs
     cfs = 1000*2.^(-4:4);
%..........................................................................
    ...
    for n = 1:numchans
        ...
        % evaluate impulse in each octave band
          ...
          for f = 1:length(cfs)
            ...
            decay_range = abs(diff(options.y_fit)); % modified both lines from hardcoded 60 to follow range from y_fit given
            [rt_temp(f,n),E_rt,fit_rt] = calc_decay(z(f,t0:end,n),options.y_fit,decay_range,fs,cfs(f)); % estimate RT
            [edt(f,n),E_edt,fit_edt] = calc_decay(z(f,t0:end,n),[0,-10],decay_range,fs,cfs(f)); % estimate EDT 
