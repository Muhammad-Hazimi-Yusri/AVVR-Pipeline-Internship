...
wsl bash -c "source /home/kproject/anaconda3/bin/activate tf2 && python enhance360.py Input depth_e.png rgb.png enhanced_depth_e.png && python infer360.py Input enhanced_depth_e.png material.png rgb.png Input %includeTopFlag%"
